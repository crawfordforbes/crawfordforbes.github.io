...
export const textPanelContent: Record<string, TextPanelContent> = {
  "about-me": {
    ...
    "description":`
      ...
      <p>At Simpleview, I spent seven years shaping the core architecture of tourism sites for global destinations and leading dev teams to ship ~30 projects annually. I’m at my best when I’m hands-on with code, mentoring developers, and collaborating across product teams to solve interesting problems.</p>

      <p>I’m looking for a role where I can remain deeply hands-on with code while contributing to high-level architecture. My ideal fit is a product-focused team where I can solve complex technical problems and translate creative vision into high-performance production reality.</p>
    `
  },
  "projects-title": {
    "id": "projects-title",
