...
library.add(faReact, faGithub, faGit, faEnvelope, faFileArrowDown, faLinkedin, faSpinner, faBars, faXmark, faCircle, faCircleXmark, faCode, faIcons, faPerson, faPeopleGroup, faPeopleArrows, faServer, faUpRightFromSquare, faDatabase, faLock, faCube, faNodeJs, faChartLine, faBolt, faVuejs, faAngleDoubleLeft, faAngleLeft, faAngleDoubleRight, faAngleRight, faImages, faFontAwesome, faCloudArrowUp, faC, faGem, faBook, faHatWizard, faDigitalOcean, faMapLocationDot, faCodeCompare, faFigma, faImagePortrait, faLess, faAngleUp, faAngleDown)
